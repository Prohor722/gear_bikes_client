    ...
    <div className="w-full bg-yellow-100 flex flex-col justify-center lg:flex-row">
      <div className="card bg-base-100 mx-4 lg:w-96 shadow-xl my-12">
        <div className="card-body text-center">
          ...
          <h2 className="text-secondary text-lg font-semibold">Pay for {order.productName}</h2>
          <p>
            Per Unit Price:{" "}
          ...
          <p>Please pay: <span className="font-semibold">${parseInt(order.price)* parseInt(order.quantity)}</span></p>
        </div>
      </div>
